...
async function convertToCssFiles(jsonContent, outputDir) {
    ...
    // Define baseCSS at function scope so it's available throughout the entire function
    let baseCSS = `/**
...
:root {
  ...
  // Add system tokens to base.css
  if (jsonContent['System-Styles/Default'] || jsonContent['System/Default']) {
    baseCSS += extractBaseSystemTokens(jsonContent);
  }
